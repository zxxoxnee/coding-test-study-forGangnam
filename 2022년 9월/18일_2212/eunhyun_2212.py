...
cell_location = list(map(int, input().split()))
cell_location.sort()
...
if cellcount >= sensor:
    ...
    for i in range(1,len(cell_location)):
        cell_diff.append(cell_location[i] - cell_location[i-1])

    cell_diff.sort(reverse=True)
    print(cell_diff)
    print(sum(cell_diff[cellcount-1:]))
